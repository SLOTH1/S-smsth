...
time.sleep(3.5)
os.system("clear")
print(Colorate.Horizontal(Colors.green_to_red,"โครงการนี้สร้างขึ้นโดยชิโด้ 👾☮️ "))
time.sleep(3.0)

print(Colorate.Horizontal(Colors.red_to_green,"สร้างขึ้นเพื่อศึกษาเท่านั้น!! "))
time.sleep(3.0)

print(Colorate.Horizontal(Colors.green_to_red,"ใช้สำหรับยิงข้อความSMS 📞🔫 "))
time.sleep(3.0)

print(Colorate.Horizontal(Colors.red_to_green,"FB : YT Sloth  "))
time.sleep(3.0)
os.system("clear")
...
print("")
print(Colorate.Horizontal(Colors.blue_to_green,"                  [15API]        "))
print("")
print(Colorate.Horizontal(Colors.blue_to_green,"¼ ½ ¾  ⅓ ⅔ ⅕ ⅖ ⅗ ⅘ ⅙ ⅚ ⅛ ⅜ ⅝ ⅞¼ ½ ¾  ⅓ ⅔ ⅕ ⅓   "))
print("")
...
for i in range(num):
  ...
  print(Colorate.Horizontal(Colors.blue_to_purple,"""🟢SMS-SHIDO🔫1"""))
  threading.Thread(target=api2).start()
  print(Colorate.Horizontal(Colors.blue_to_purple,"""🟢SMS-SHIDO🔫2"""))
  threading.Thread(target=api3).start()
  print(Colorate.Horizontal(Colors.blue_to_purple,"""🟢SMS-SHIDO🔫3"""))
  threading.Thread(target=api4).start()
  print(Colorate.Horizontal(Colors.blue_to_purple,"""🟢SMS-SHIDO🔫4"""))
  threading.Thread(target=api5).start()
  print(Colorate.Horizontal(Colors.blue_to_purple,"""🟢SMS-SHIDO🔫5"""))
  threading.Thread(target=api6).start()
  print(Colorate.Horizontal(Colors.blue_to_purple,"""🟢SMS-SHIDO🔫6"""))
  threading.Thread(target=api7).start()
  print(Colorate.Horizontal(Colors.blue_to_purple,"""🟢SMS-SHIDO🔫7"""))
  threading.Thread(target=api8).start()
  print(Colorate.Horizontal(Colors.blue_to_purple,"""🟢SMS-SHIDO🔫8"""))
  threading.Thread(target=api9).start()
  print(Colorate.Horizontal(Colors.blue_to_purple,"""🟢SMS-SHIDO🔫9"""))
  threading.Thread(target=api10).start()
  print(Colorate.Horizontal(Colors.blue_to_purple,"""🟢SMS-SHIDO🔫10"""))
  threading.Thread(target=api11).start()
  print(Colorate.Horizontal(Colors.blue_to_purple,"""🟢SMS-SHIDO🔫11"""))
  threading.Thread(target=api12).start()
  print(Colorate.Horizontal(Colors.blue_to_purple,"""🟢SMS-SHIDO🔫12"""))
  threading.Thread(target=api13).start()
  print(Colorate.Horizontal(Colors.blue_to_purple,"""🟢SMS-SHIDO🔫13"""))
  threading.Thread(target=api14).start()
  print(Colorate.Horizontal(Colors.blue_to_purple,"""🟢SMS-SHIDO🔫14"""))
  threading.Thread(target=api15).start()
  print(Colorate.Horizontal(Colors.blue_to_purple,"""🟢SMS-SHIDO🔫15"""))
  threading.Thread(target=call1).start()
  print(Colorate.Horizontal(Colors.blue_to_purple,"""🟢SMS-SHIDO🔫+call1"""))